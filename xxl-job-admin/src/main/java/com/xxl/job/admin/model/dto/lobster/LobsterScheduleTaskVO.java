...
public class LobsterScheduleTaskVO {
	...
	public static LobsterScheduleTaskVO from(LobsterScheduleTask task) {
		if (task == null) {
			return null;
		}
		LobsterScheduleTaskVO vo = new LobsterScheduleTaskVO();
		vo.setId(task.getId());
		vo.setUserId(task.getUserId());
		vo.setLobsterId(task.getLobsterId());
		vo.setTaskName(task.getTaskName());
		vo.setMessageContent(task.getMessageContent());
	...
	public Integer getXxlJobId() { return xxlJobId; }
	public void setXxlJobId(Integer xxlJobId) { this.xxlJobId = xxlJobId; }
	...
	public String getLastExecuteStatus() { return lastExecuteStatus; }
	public void setLastExecuteStatus(String lastExecuteStatus) { this.lastExecuteStatus = lastExecuteStatus; }
	public String getLastExecuteMsg() { return lastExecuteMsg; }
	public void setLastExecuteMsg(String lastExecuteMsg) { this.lastExecuteMsg = lastExecuteMsg; }
